...
?>
        <section id="home" class="home featured">
            <h3 class="section-title text-right"><span>Featured<span class="circle-icon title-icon icon-star"></span></span></h3>
            <div class="carousel-container">
                <ul class="carousel">
                    <? foreach ($featured_projects as $project) : ?>
                    <li class="slide" data-title="<? echo $project->post_title; ?>">
                        <a href="<? echo $project->permalink; ?>" title="<? echo $project->post_title; ?>">
                            <? echo $project->img; ?>
                        </a>
                    </li>
                    <? endforeach; ?>
            ...
            <nav class="quick-links clearfix">
                <div>
                    ...
                    <p>I&rsquo;m a Jr. Developer at Odopod and a recent New Media Interactive Development graduate from <a href="http://rit.edu">RIT</a></p>
                    <p><a href="#about">More about me<span class="icon-chevron-right"></span></a></p>
                </div>
                <div>
                    ...
                    <p><a href="#work">View my work<span class="icon-chevron-right"></span></a></p>
                </div>
                <div>
                    ...
                    <p><a href="#contact">Get in touch<span class="icon-chevron-right"></span></a></p>
                </div>
                <div>
                    ...
                    <p><a href="<?php bloginfo('url'); ?>/blog">Visit my blog<span class="icon-chevron-right"></span></a></p>
                </div>
            </nav>
        </section>