        ...
        <Link className={styles.link} to="/">
          <svg viewBox="0 0 32 32" width={24} height={24}>
            ...
            <g>
              ...
              <path className={`${styles.polygon} ${styles.small}`} fill="#4d85a9" d="M16.747 12.024l-6.747 5.976 8-16-1.253 10.024z" />
              ...
              <path className={`${styles.polygon} ${styles.small}`} fill="#517e9a" d="M18 2l-.744 6.012-3.256 1.988 4-8z" />
